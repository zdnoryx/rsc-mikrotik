/ip firewall raw
rem [find address-list=Mikrotik-Netflix]
add action=add-dst-to-address-list address-list=Mikrotik-Netflix address-list-timeout=1d chain=prerouting content=netflix.com dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="Netflix"
add action=add-dst-to-address-list address-list=Mikrotik-Netflix address-list-timeout=1d chain=prerouting content=.netflix. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
add action=add-dst-to-address-list address-list=Mikrotik-Netflix address-list-timeout=1d chain=prerouting content=.nflxvideo. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
add action=add-dst-to-address-list address-list=Mikrotik-Netflix address-list-timeout=1d chain=prerouting content=.nflxext. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
add action=add-dst-to-address-list address-list=Mikrotik-Netflix address-list-timeout=1d chain=prerouting content=.nflxvideo. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
