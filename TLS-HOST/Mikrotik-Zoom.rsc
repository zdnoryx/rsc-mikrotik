/ip firewall raw
rem [find address-list=Mikrotik-Zoom]
add action=add-dst-to-address-list address-list=Mikrotik-Zoom address-list-timeout=1d chain=prerouting content=zoom.us dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="Zoom"
add action=add-dst-to-address-list address-list=Mikrotik-Zoom address-list-timeout=1d chain=prerouting content=.zoom. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
add action=add-dst-to-address-list address-list=Mikrotik-Zoom address-list-timeout=1d chain=prerouting content=.zoomus. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
add action=add-dst-to-address-list address-list=Mikrotik-Zoom address-list-timeout=1d chain=prerouting content=.meetzoom. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
add action=add-dst-to-address-list address-list=Mikrotik-Zoom address-list-timeout=1d chain=prerouting protocol=tcp dst-port=3478,3479,5090,5091,8801-8810 dst-address-list=Mikrotik-Zoom src-address-list=LOCAL-IP
add action=add-dst-to-address-list address-list=Mikrotik-Zoom address-list-timeout=1d chain=prerouting protocol=udp dst-port=3478,3479,5090,5091,8801-8810 dst-address-list=Mikrotik-Zoom src-address-list=LOCAL-IP
